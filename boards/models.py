...
class Topic(models.Model):
	...
	starter = models.ForeignKey(User, related_name='topics', on_delete="cascade", null=True)
...
class Post(models.Model):
	...
	created_by = models.ForeignKey(User, related_name='posts', on_delete="cascade", null=True)
